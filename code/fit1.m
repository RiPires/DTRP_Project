...
function [param,new_param,chi2_val] = perform_fit(files,N,d,D,T_day,T_month,initial_guess,lower_bound,upper_bound,fitting_function,purpose)
    ...
    % Chi-square function
    chi2 = @(v) chi2_residuals(files, N, d, D, T_day, T_month, v, fitting_function,purpose);
...
function r = chi2_residuals(files, N_list, d_list, D_list, T_day_list, T_month_list, v, f,purpose)
