...
handles.radiobutton_Fit1 = uicontrol(handles.FitSelection,...
    ...
    'Units',                'Normalized', ...
    'Position',             [.2 .3 .2 .5],...
    'TooltipString',        '<html>Select Model 1<br />  Cmpt. time ~ 5s</html>',...
    'FontSize',             10,...
...
handles.radiobutton_Fit2 = uicontrol(handles.FitSelection,...
    ...
    'Units',                    'Normalized', ...
    'Position',                 [.8 .3 .2 .5],...
    'TooltipString',            '<html>Select Model 2<br />  Cmpt. time ~ 15s</html>',...
    'FontSize',                 10,...
...
handles.fit2optionsuitable = olduitable(panel_Fit,...
