...
handles.axes_logo = axes('Parent',mainFig,...
    'Units','Normalized','Position',[0.03 0.89 0.12 0.12],...
    'Visible','off');
tmp=image(tmp);
...
%-------------------------
handles.axes_plot = axes('Parent',handles.panel_Plot,...
    'Units','Normalized','Position',[0.1 0.1 0.88 0.85],...
    'Visible','on');
...
handles.fitoptionsuitable = uitable(panel_Fit,...
    ...
    'ColumnEditable',true,...
    'ColumnName',{'K' 'Alpha' 'Beta' 'gamma' 'a' 'delta'},...
    'RowName',{'Init. Guess' 'Low' 'Up'},...
    'Userdata',FitInput,...
