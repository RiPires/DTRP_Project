...
handles.fit2optionsuitable = uitable(panel_Fit,...
    ...
    'Visible', 'off',...
    'ColumnEditable',true,...
    'ColumnName',{'<html>K<sub>50</sub><span>&#47;</span>K<sub>0</sub></html>' '<html><center />&alpha<br /> [Gy<sup>-1</sup>]</html>' ...
    '<html><center />&beta<br />[Gy<sup>-2</sup>]</html>' '<html>&gamma</html>' ...
    '<html><center /> &sigma<sub>k</sub> <span>&#47;</span>K<sub>0</sub></html>' '<html>&delta</html>'},...
    'ColumnWidth', {50, 50, 50, 50, 50, 50},...
    'RowName',{'Initial Guess' 'Lower limit' 'Upper limit'},...
    'Userdata',FitInput,...
    'CellEditCallback',@fitoptionsuitable_Callback);
...
handles.pushbutton_fit = uicontrol(panel_Fit,...
    ...
    function pushbutton_Fit_Callback(~,~)
        ...
        if strcmp(state1, 'on')
            ...
            FitData = {round(str2double(K),5) round(str2double(alpha),5) round(str2double(beta),5) round(str2double(alpha)/str2double(beta),3) round(str2double(gamma),5) round(str2double(a),5) round(str2double(Td),0) round(str2double(delta),5)};
        ...
        elseif strcmp(state2, 'on')
            ...
            FitData = {round(str2double(K50_K0),5) round(str2double(alpha),5) round(str2double(beta),5) round(str2double(alpha)/str2double(beta),3) round(str2double(gamma),5) round(str2double(Td),0) round(str2double(sigmak_k0),5) round(str2double(delta),5)};
