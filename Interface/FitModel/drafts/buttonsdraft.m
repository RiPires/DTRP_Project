...
%--------------------------------------------------------------------------
handles.valSel = false;   
handles.listFits = [0, 0]; 
handles.listPlots = [0, 0, 0, 0, 0, 0]; 
handles.tauValues = {0, 0, 0, 0};
handles.dValue = 0;
...
function pushbutton_Plots_Callback(~,~)
    ...
    global dValue;
    dValue = 0; % value of the dose per fraction selected by the user
   ...
   handles.tauEQD2Fit2 = uicontrol('Parent', EQD2PanelFit2, ...
    ...
    function [dValid] = dvalButtonCallback(~,~)
        ...
        if dValid == true
            ...
            dValue = 2;
            % if the user does not insert a valid value for d, d assumes
            % its default value: 2 Gy/fx
        end
    end
